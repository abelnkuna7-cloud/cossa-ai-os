...
const phases: Phase[] = [
  { id: 1, name: "Platform Foundation", status: "Live", progress: 100, timeline: "Q1 — Q2 2026",
    summary: "Design system, workspace shell, module architecture, roadmap, reusable components and integration surface.",
    deliverables: ["Design system & tokens", "Workspace shell + sidebar", "Reusable component library", "Roadmap & status system"] },
  { id: 2, name: "CRM Intelligence", status: "Live", progress: 85, timeline: "Q2 2026",
  ...
  { id: 3, name: "Marketing AI", status: "Live", progress: 70, timeline: "Q3 2026",
  ...
  { id: 4, name: "Sales AI", status: "Live", progress: 75, timeline: "Q3 — Q4 2026",
  ...
  { id: 5, name: "Automation Engine", status: "Live", progress: 55, timeline: "Q4 2026",
    summary: "Workflow builder specialist, prompt library, AI automations advisor and cross-module orchestration foundations.",
    deliverables: ["Workflow builder", "Prompt library", "AI automations", "Ops automation"] },
