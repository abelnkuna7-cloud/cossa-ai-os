...
const phases: Phase[] = [
  { id: 1, name: "Platform Foundation", status: "Development", progress: 65, timeline: "Q1 — Q2 2026",
    summary: "Design system, workspace shell, module architecture, roadmap, reusable components and future-ready integration surface.",
    deliverables: ["Design system & tokens", "Workspace shell + sidebar", "Reusable component library", "Roadmap & status system"] },
  { id: 2, name: "CRM Intelligence", status: "Design", progress: 25, timeline: "Q2 2026",
    summary: "AI-native CRM: leads, pipeline, customers, companies, appointments and quotations, powered by unified customer intelligence.",
    deliverables: ["Contacts & companies", "Pipeline & deals", "Appointments & quotes", "AI enrichment & scoring"] },
  { id: 3, name: "Marketing AI", status: "Planning", progress: 10, timeline: "Q3 2026",
    summary: "AI Marketing Director orchestrating SEO, Google Ads, Meta Ads, social, email, WhatsApp and landing pages.",
    deliverables: ["AI Marketing Director", "SEO Center", "Ads managers", "Content & landing pages"] },
  { id: 4, name: "Sales AI", status: "Planning", progress: 5, timeline: "Q3 — Q4 2026",
    summary: "AI Sales Assistant, forecasting, analytics and outbound lead finder tuned for South African markets.",
    deliverables: ["AI Sales Assistant", "Forecasting", "Analytics", "Lead Finder"] },
  { id: 5, name: "Automation Engine", status: "Planning", progress: 5, timeline: "Q4 2026",
    summary: "Workflow builder, prompt library, AI automations and cross-module orchestration.",
    deliverables: ["Workflow builder", "Prompt library", "AI automations", "Marketplace of recipes"] },
