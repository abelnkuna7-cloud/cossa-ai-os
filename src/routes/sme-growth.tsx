...
export const Route = createFileRoute("/sme-growth")({
  ...
  head: () => ({ meta: [{ title: "AI Business Growth Operating System for African SMEs | Cossa AI" }, { name: "description", content: "Cossa AI is an evidence-led business growth operating system for ambitious African SMEs." }, { name: "robots", content: "index, follow" }] }),
});
