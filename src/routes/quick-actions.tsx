...
export const Route = createFileRoute("/quick-actions")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Shortcut launcher for the most common actions across Cossa AI.",
      },
...
const GROUPS: Group[] = [
  {
    ...
    actions: [
      {
        title: "Add lead",
        description: "Capture a new lead and score it.",
        to: "/sales/leads",
        icon: UserPlus,
      },
      {
        title: "New opportunity",
        description: "Open a deal in the pipeline.",
      ...
      },
      {
        ...
        description: "Schedule a customer meeting.",
        to: "/sales/appointments",
        icon: CalendarDays,
      },
      {
        title: "Log follow-up",
        description: "Queue a follow-up with SLA.",
        to: "/sales/follow-ups",
        icon: Bell,
      },
      {
      ...
      {
        title: "View pipeline",
        description: "Advance deals on the board.",
        to: "/sales/pipeline",
        icon: KanbanSquare,
      },
    ],
  },
  {
    ...
    actions: [
      {
        title: "New project",
        description: "Kick off a project workspace.",
        to: "/operations/projects",
        icon: KanbanSquare,
      },
      {
        title: "Add task",
        description: "Assign a task with a due date.",
        to: "/operations/tasks",
        icon: ListChecks,
      },
      {
        title: "Store document",
        description: "File a contract or SOP.",
        to: "/operations/documents",
        icon: Files,
      },
      {
        title: "Open calendar",
        description: "Unified schedule of everything due.",
  ...
  },
  {
    ...
    actions: [
      ...
      {
        title: "AI Workforce",
        description: "Set up controlled worker handoffs and an owner briefing.",
        to: "/ai/workforce",
        icon: UsersRound,
      },
      {
        title: "AI Business Coach",
        description: "Daily coaching and focus.",
        to: "/ai/coach",
        icon: GraduationCap,
      },
      {
        title: "Prompt Library",
        description: "Reuse proven prompts.",
        to: "/ai/prompts",
        icon: Sparkles,
      },
      {
        title: "Knowledge Base",
        description: "Ground AI in your business.",
        to: "/ai/knowledge",
        icon: Search,
      },
    ],
  },
  {
    ...
    actions: [
      {
        title: "Ask AI Marketing Director",
        description: "Strategy and channel mix.",
        to: "/marketing/ai-director",
        icon: Megaphone,
      },
      {
        title: "Draft content",
        description: "Blog, ads, social — on brand.",
      ...
      {
        title: "SEO center",
        description: "Keyword and site health.",
        to: "/marketing/seo",
        icon: Search,
      },
    ],
