    ...
    <CrudWorkspace<OpsProject>
      ...
      columns={[
        ...
        { key: "priority", label: "Priority", render: (r) => (
          <span className={r.priority === "urgent" ? "text-destructive" : r.priority === "high" ? "text-warning" : "text-muted-foreground"}>{r.priority}</span>
        ) },
        { key: "progress", label: "Progress", render: (r) => (
          <div className="min-w-[120px]">
            <div className="flex justify-between text-[10px]"><span>{r.progress}%</span></div>
